...
`r dim(state_distinct)[1]` states are represented (likely, DC got counted as a location) - so, every state is represented. 
* What state is observed the most? `r tail(names(sort(table(location_distinct$location))), 1)`
* In 2002, what is the median of the “Excellent” response value? `r median(subset(brfss_data, year == "2002")$excellent, na.rm = TRUE)`.
